...
return array(
    ...
    */
    ...
    |
    */
    'exceptFiles'   => array( 'robots.txt', 'index.php', '.DS_Store', '.Thumbs.db', 'web.config'),
    ...
    |
    */
    'exceptFolders' => array( 'vendor', 'thumbs', 'filemanager_assets', 'installer','js', 'fonts', 'views'),
